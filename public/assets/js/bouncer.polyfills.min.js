...
(function (root, factory) {
	...
	var defaults = {
		...
		messages: {
			missingValue: {
				checkbox: 'Este campo é requerido.',
			...
			patternMismatch: {
				...
				color: 'Por favor, corresponda o seguinte formato: #rrggbb',
				date: 'Use o formato DD-MM-AAAA',
				time: 'Use o formato de 24 horas. Ex. 23:00',
				month: 'Use o formato MM-AAAA',
				default: 'Por favor, corresponda ao formato solicitado'
			},
			outOfRange: {
				over: 'Selecione um valor que não seja maior que {max}.',
				under: 'Selecione um valor que não seja menor que {min}.'
			},
			wrongLength: {
				over: 'Reduza este texto para não mais do que {maxLength} carácteres . Você está usando atualmente {length} carácteres.',
				under: 'Aumente este texto para {minLength} carácteres ou mais. Você está usando atualmente {length} carácteres.'
			},
